...
export function RegisterPage() {
  ...
  return (
    <div className="max-w-sm mx-auto mt-12">
      <h1 className="text-2xl font-bold text-brand-primary dark:text-[#f5f0eb] text-center mb-6">Create Account</h1>
      <form onSubmit={handleSubmit} className="bg-brand-surface dark:bg-[#2c1810] rounded-2xl border border-brand-border dark:border-[#4a2e20] p-6 space-y-4">
        ...
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-brand-primary dark:text-[#f5f0eb] mb-1">Name</label>
          <input
            id="name"
            type="text"
            value={name}
