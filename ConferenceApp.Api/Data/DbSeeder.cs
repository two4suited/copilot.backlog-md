...
public static class DbSeeder
{
    public static async Task SeedAsync(ConferenceDbContext db)
    {
        ...
        var spAlice    = new Speaker { Name = "Alice Chen",          Bio = "Senior Software Engineer at Contoso, specialising in distributed systems and cloud-native architecture with 12 years of experience building high-throughput APIs.", Email = "alice@example.com",     Company = "Contoso",             TwitterHandle = "@alicechen",      PhotoUrl = Avatar("alice@example.com") };
        var spBob      = new Speaker { Name = "Bob Martinez",        Bio = "Full-stack developer and open-source contributor with 10 years of experience in .NET and React. Passionate about developer experience and tooling.", Email = "bob@example.com",       Company = "Fabrikam",            TwitterHandle = "@bobdev",         PhotoUrl = Avatar("bob@example.com") };
        var spCarol    = new Speaker { Name = "Carol Johnson",       Bio = "Principal Engineer at Microsoft working on the .NET runtime. She drives performance initiatives that ship in every release of .NET Core.", Email = "carol@microsoft.com",   Company = "Microsoft",           TwitterHandle = "@carolj_msft",    PhotoUrl = Avatar("carol@microsoft.com") };
        var spDavid    = new Speaker { Name = "David Kim",           Bio = "Staff Engineer at Google leading the Site Reliability Engineering practice for Google Cloud Run. Author of popular Kubernetes reliability patterns.", Email = "david@google.com",      Company = "Google",              TwitterHandle = "@davidkim_sre",   PhotoUrl = Avatar("david@google.com") };
        var spEmma     = new Speaker { Name = "Emma Wilson",         Bio = "Principal Cloud Architect at AWS specialising in multi-region resilient systems. AWS Hero and frequent conference keynote speaker.", Email = "emma@aws.com",          Company = "Amazon Web Services", TwitterHandle = "@emmawilson_aws", PhotoUrl = Avatar("emma@aws.com") };
        var spFrank    = new Speaker { Name = "Frank Brown",         Bio = "Distinguished Engineer at Netflix working on the streaming platform data pipeline. Co-creator of the Netflix OSS chaos engineering toolkit.", Email = "frank@netflix.com",     Company = "Netflix",             TwitterHandle = "@frankb_oss",     PhotoUrl = Avatar("frank@netflix.com") };
        var spGrace    = new Speaker { Name = "Grace Davis",         Bio = "Engineering Manager at Meta leading the React core team. Contributor to the React Server Components RFC and concurrent mode stabilisation.", Email = "grace@meta.com",        Company = "Meta",                TwitterHandle = "@gracedavis",     PhotoUrl = Avatar("grace@meta.com") };
        ...
        var spIsabella = new Speaker { Name = "Isabella Rodriguez",  Bio = "Senior Developer Advocate at Shopify, specialising in Hydrogen (React-based storefront framework) and edge computing use-cases.", Email = "isabella@shopify.com",  Company = "Shopify",             TwitterHandle = "@isabellar",      PhotoUrl = Avatar("isabella@shopify.com") };
        var spJames    = new Speaker { Name = "James Wilson",        Bio = "Staff Engineer at GitHub working on Actions infrastructure and developer workflows. Contributor to multiple CNCF open-source projects.", Email = "james@github.com",      Company = "GitHub",              TwitterHandle = "@jameswilson",    PhotoUrl = Avatar("james@github.com") };
        var spKate     = new Speaker { Name = "Kate Anderson",       Bio = "Head of Developer Experience at Vercel. Formerly on the Next.js core team; now focused on edge rendering and incremental static regeneration.", Email = "kate@vercel.com",       Company = "Vercel",              TwitterHandle = "@kateanderson",   PhotoUrl = Avatar("kate@vercel.com") };
        var spLiam     = new Speaker { Name = "Liam Chen",           Bio = "Senior Software Engineer at HashiCorp, author of several Terraform providers and the go-getter library used by the broader HashiCorp ecosystem.", Email = "liam@hashicorp.com",    Company = "HashiCorp",           TwitterHandle = "@liamchen_hcp",   PhotoUrl = Avatar("liam@hashicorp.com") };
        var spMia      = new Speaker { Name = "Mia Williams",        Bio = "Principal Engineer at Cloudflare working on Workers and the edge-computing runtime. Speaker on WebAssembly, V8 isolates, and serverless security.", Email = "mia@cloudflare.com",    Company = "Cloudflare",          TwitterHandle = "@miawilliams",    PhotoUrl = Avatar("mia@cloudflare.com") };
        var spNoah     = new Speaker { Name = "Noah Taylor",         Bio = "Core maintainer of the Moby project at Docker and contributor to containerd and the OCI runtime spec. Talks frequently about container internals and image layering.", Email = "noah@docker.com",       Company = "Docker",              TwitterHandle = "@noahtaylor_oci", PhotoUrl = Avatar("noah@docker.com") };
        var spOlivia   = new Speaker { Name = "Olivia Brown",        Bio = "Developer Advocate at JetBrains with deep expertise in Kotlin and the IntelliJ Platform. Author of Idiomatic Kotlin and regular KotlinConf keynote speaker.", Email = "olivia@jetbrains.com",  Company = "JetBrains",           TwitterHandle = "@oliviabrown_jb", PhotoUrl = Avatar("olivia@jetbrains.com") };
        var spPatrick  = new Speaker { Name = "Patrick Garcia",      Bio = "Principal Architect at Red Hat working on OpenShift and the Kubernetes Operator Framework. Active CNCF TOC member and SIG lead.", Email = "patrick@redhat.com",    Company = "Red Hat",             TwitterHandle = "@patrickgarcia",  PhotoUrl = Avatar("patrick@redhat.com") };
        var spQuinn    = new Speaker { Name = "Quinn Robinson",      Bio = "Staff Engineer at Elastic working on Elasticsearch performance and the ECS (Elastic Common Schema). Frequent speaker on search relevance and vector search.", Email = "quinn@elastic.com",     Company = "Elastic",             TwitterHandle = "@quinnrobinson",  PhotoUrl = Avatar("quinn@elastic.com") };
