...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Admin-only route /admin/* redirects non-admins to home
- [ ] #2 Admin can create/edit/delete conferences
- [ ] #3 Admin can create/edit/delete sessions and assign speakers
- [ ] #4 Admin can create/edit/delete speakers
- [ ] #5 Forms validate required fields and show inline errors
<!-- AC:END -->
